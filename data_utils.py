...
def build_embedding_matrix(word2idx, embed_dim, type):
    ...
    if os.path.exists(embedding_matrix_file_name):
        ...
        if embed_dim == 100:
            fname = p.dataset_path + "/glove.6B.100d.txt"
        else:
            fname = p.dataset_path + '/glove.42B.300d.txt'
...
class DatesetReader:
    ...
    def __init__(self, dataset='twitter', embed_dim=300, max_seq_len=-1):
        ...
        fname = {
            'riloff': {
                'train': p.dataset_path + '/final_train.raw',
                'test': p.dataset_path + '/final_test.raw',
                'examples': p.dataset_path + '/examples.raw',
            },
            'ptacek': {
                'train': p.dataset_path + '/final_train.raw',
                'test': p.dataset_path + '/final_test.raw',
