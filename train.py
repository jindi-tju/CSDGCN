        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(self.train_data_loader):
                ...
                if global_step % self.opt.log_step == 0:
                    ...
                    test_acc, test_f1, test_precision, test_recall = self._evaluate_acc_f1()
                    ...
                    print("max test f1: ", max_test_f1, "max test acc: ", max_test_acc, "max test pre: ",
                          max_test_precision, "max test recall: ", max_test_recall)
    ...
    def run(self, repeats=3):
        ...
        if self.opt.do_train:
            ...
            for i in range(repeats):
                ...
                self._reset_params()
                max_test_acc, max_test_f1, max_test_precision, max_test_recall = self._train(criterion, optimizer)
                if max_test_acc > acc:
                    acc = max_test_acc
                    params_dic = self.model.state_dict()
            ...
            torch.save(params_dic, 'params.ckpt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='csdgcn', type=str)
    parser.add_argument('--dataset', default='riloff', type=str, help='twitter, rest14, lap14, rest15, rest16')
    ...
    parser.add_argument('--estop', default=10, type=int)
    ...
    input_colses = {
        'csdgcn': ['context', 'context_indices',
                   'dependency_graph',
                   'sentic_graph'],
    }
    initializers = {
